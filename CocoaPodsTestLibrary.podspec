...
#    ss.dependency 'AppLovinMediationLineAdapter', '2.6.20230609.0'
  ...
  s.subspec 'ModuleB' do |ss|
    ...
    ss.public_header_files = 'ModuleB/**/*.{h,hpp}'
    ss.dependency 'CocoaPodsTestLibrary/ModuleCore'
  end
end
